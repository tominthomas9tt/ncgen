...
// if (!function_exists("getBaseComponentHtml")) {
//     function getBaseComponentHtml($resourceName, $params)
//     {
//         $cappedName = ucfirst($resourceName);
//         $tableColumns = '';
//         if (!empty($params)) {
//             foreach ($params as $param) {
//                 $tableColumns .= `<ng-container matColumnDef="` . $param->propertyName . `">
//                 <th mat-header-cell *matHeaderCellDef>` . $param->name . `</th>
//                 <td mat-cell *matCellDef="let row"> {{row.` . $param->propertyName . `}} </td>
//             </ng-container>`;
//             }
//         }
//         $data = `<ion-content color="light">
//         <ion-grid fixed>
//             <ion-row>
//                 <ion-col size="6">
//                     <app-back [title]="'` . $cappedName . `'"></app-back>
//                 </ion-col>
//                 <ion-col size="6" class="ion-text-right">
//                     <ion-button (click)="modify()">
//                         New
//                     </ion-button>
//                 </ion-col>
//             </ion-row>
...
//                             </mat-panel-title>
//                         </mat-expansion-panel-header>
//                         <app-filter (filterSubmitEvent)="onFilterApplied(\$event)"></app-filter>
//                     </mat-expansion-panel>
//                 </ion-col>
//             </ion-row>
//             <ion-row>
...
//                             <tr mat-row *matRowDef="let row; columns: displayedColumns;" (click)="viewDetails(row)">
//                             </tr>
